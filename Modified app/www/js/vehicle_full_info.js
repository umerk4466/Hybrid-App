...
function removeVehicle() {
    try {
        ...
        $.getScript("js/database.js", function (data, textStatus, jqxhr) {
            ...
            try {
                try {
                    deleteVehicleDB(window.sessionStorage.getItem("full_info_vehicle_id"));
                }
                catch (e) {
...
function getVehicleInfo() {
    try {
        if (window.sessionStorage.getItem("full_info_img_url") === null) {
            window.sessionStorage.setItem("full_info_img_url", "img/mycars/no_image.jpg");
        }
        $("#full_vehicle_div").append(
            "<div class='card'><img src='" +
            window.sessionStorage.getItem("full_info_img_url") +
